...
public class MenteActivity extends Activity implements
	...
	//リストにて選択したHitokototテーブルのレコードの「_id」カラム値
	int selectedID = -1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mente_activity);
	}
	@Override
	protected void onResume() {
		...
		//各ButtonにOnCluckListenerをセット
		btnD.setOnClickListener(this);
		btnB.setOnClickListener(this);

		//ListViewにOnItemCliclListenerをセット
	...
	/**
	 * Hitokotoテーブル、引数で指定した「_id」と同じ値を持つレコードを削除
	 * @param id 指定する値
	 */
